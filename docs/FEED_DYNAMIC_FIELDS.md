...
- **Type:** boolean
- **Description:** **Offers-0 only.** When `true`, photo-act headlines use brand navy; when `false` (default), white. T&Cs stay white. Act 4 is always navy over the green wave. Scrim stays on for all offers-0 ink.
