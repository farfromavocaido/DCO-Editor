...
export const categories = [
  ...
  { name: 'Typography', domain: 'values', fields: { fontFamily: 'Font family', fontWeight: 'Font weight', fontStyle: 'Font style', fontSize: 'Font size', lineHeight: 'Line height', letterSpacing: 'Letter spacing', textAlign: 'Horizontal alignment', alignItems: 'Vertical alignment' } },
