...
import { ownershipDestinations, validOwnershipProperty, copyOwnershipSelection, editOwnershipVersion, replaceOwnershipDestinationLocals, suppliedOwnershipFields } from './ownership-ui';
...
describe('ownership destination controls', () => {
 ...
 it('requires destinations and valid selected fields', () => {
  expect(() => copyOwnershipSelection(fixture(),'300x250','title',[],[],[])).toThrow(/format and offer count/);
