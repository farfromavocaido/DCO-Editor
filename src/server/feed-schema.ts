...
export const FEED_SCHEMA_FIELDS = [
  ...
  { name: 'heading1_text', label: 'Heading 1', type: 'string', group: 'Copy', description: 'Act 1 headline copy.' },
  { name: 'heading2_text', label: 'Heading 2', type: 'string', group: 'Copy', description: 'Act 2 headline copy.' },
  { name: 'heading3_text', label: 'Heading 3', type: 'string', group: 'Copy', description: 'Act 3 headline copy over the offer roundel (when enabled).' },
  { name: 'heading4_text', label: 'Heading 4', type: 'string', group: 'Copy', description: 'Act 4 headline copy over the CTA/endframe.' },
  ...
  { name: 'tc_terms_text', label: 'T&Cs text', type: 'string', group: 'Copy', description: 'Terms and conditions line.' },
